...
class CRegMkt
{
	...
	function showMarket($symbol)
	{
		...
		$this->template->showMenu("Transactions", "Owners");
		$this->showTrans($symbol);
		$this->showNewOrderModal($symbol);
	}
	
	function newOrder($net_fee_adr, $adr, $mkt_symbol, $tip, $qty)
	{
	    // Address owner
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td align="center"><table width="120" border="0" cellspacing="0" cellpadding="0">
                                <tbody>
                                  <tr>
                                    <td height="30" align="center" bgcolor="#f4edde" class="simple_maro_12"><? print $row['asset']; ?> Balance</td>
                                  </tr>
                                  <tr>
                                    <td height="50" align="center" bgcolor="#f8f4eb" class="simple_red_20">
									<? print round($this->kern->getBalance($row['mkt_adr'], $row['asset']), 4); ?></td>
                                  </tr>
                                </tbody>
                              </table></td>
                            </tr>
                        ...
                        <td width="64%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                              ...
                              <tr>
                                <td align="right" class="simple_maro_12">Currency Symbol&nbsp;&nbsp;</td>
                                <td height="30"><a href="#" class="red_12"><strong>
								<? print $row['cur']; ?></strong></a></td>
                              </tr>
                              <tr>
                  ...
                  <td height="95" align="center" valign="top" background="../../template/template/GIF/4_panels.png"><table width="530" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      ...
                      <tr class="simple_red_22">
						...
						<? print $this->kern->getMyBalance($row['asset']); ?></strong></td>
                        <td align="center" valign="bottom">&nbsp;</td>
                        <td align="center" valign="bottom" class="simple_red_18"><strong><? print $row['price_ask']; ?></strong></td>
                        <td align="center" valign="bottom">&nbsp;</td>
                      ...
                      <tr class="simple_blue_10">
                        <td height="0" align="center" valign="bottom"><? print $row['asset']; ?></td>
                        <td align="center" valign="bottom">&nbsp;</td>
