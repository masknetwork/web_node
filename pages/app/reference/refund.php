   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>REFUND</strong></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;REFUND</strong></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
           </tr>
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Refunds the last transaction. When an application is &quot;waked-up&quot; by a trasanction and a refund signal is issued, the transaction will not be executed.</td>
                   </tr>
                 </tbody>
               </table></td>
           </tr>
           ...
           <tr>
             ...
             <div id="editor_code" align="left">// This small app will refund any incoming transaction
