   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>REGEX</strong></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;REGEX dest, subject, pattern</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">The location that will hold the matching result (1 if a match is found and 0 otherwise
                     
                     ). It can be a register or a variable.</td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   ...
                   <td align="left" valign="top" class="fnt_14">Required. The pattern to search for, as a string. It can be a register, a variable or a string.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                 </tr>
                 <tr>
                   <td align="right" valign="top" class="fnt_14"><strong>pattern</strong></td>
                   <td align="right" valign="top" class="fnt_14">&nbsp;</td>
                   <td align="left" valign="top" class="fnt_14">Required. The pattern to search for, as a string. It can be a register, a variable or a string.</td>
                 </tr>
                 </tbody>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Perform a regular expression match on <strong>subject</strong> using the <strong>pattern</strong>. In case a match is found, the <strong>dest</strong> operand will hold value 1 or 0 otherwise.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
...
// Initialize $pat variable
mov $pat, "^[0-9]+"

// Check if variable pattern is a number (contains only digits)
regex r1, $str, $pat
 </div>
