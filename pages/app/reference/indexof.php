   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>INDEXOF</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;INDEXOF dest, haystack, niddle</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">The result will be stored by this.operand. It can be a variable or a register.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td width="12%" align="right" valign="top" class="fnt_14"><strong>haystack</strong></td>
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">This string will be searched for <strong>niddle</strong> occurrence. It can be a variable, a register or string.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td align="right" valign="top" class="fnt_14"><strong>niddle</strong></td>
                   <td>&nbsp;</td>
                   <td class="fnt_14">This operand holds the substring that will be searched. It can be a variable, a register or string.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Returns and stores in <strong>dest</strong>, the index within the <strong>haystack</strong> of the first occurrence of the specified <strong>niddle</strong>. If it does not occur as a substring, -1 is returned.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
...
mov r1, "this is a test"
             
// Search for substring is inside r1 and stores the result in $pos variable
indexof $pos, r1, "is"
