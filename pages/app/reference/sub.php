   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>SUB</strong></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;SUB op1, op2</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">The value from which op2 will be substracted. This operand will also hold the result. It can be a register, a variable or a number.</td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   ...
                   <td align="left" valign="top" class="fnt_14">The value that will be substracted from op1. It can be a register, a variable or a number.</td>
                 </tr>
                 </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Substract <strong>op2</strong> from <strong>op1</strong> and stores the result in <strong>op1</strong>.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
...
// Substract 3 from r1 and stores the result in r1
sub r1, 3

// Substract 1.5 from r1 and stores the result in r1
sub r1, 1.5
 </div>
