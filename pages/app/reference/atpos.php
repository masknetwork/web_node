   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>ATPOS</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;ATPOS dest, haystack, pos</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">Destination operand. This operand will hold the result. It can be a variable or a register.</td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">The string / array to search in. It can be a string or a list.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td align="right" valign="top" class="fnt_14"><strong>pos</strong></td>
                   <td>&nbsp;</td>
                   <td class="fnt_14">Position.  </td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Returns the character / cell at position <strong>pos</strong> of  string / array <strong>haystack</strong> and put the result to <strong>dest</strong> operand.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
...
// Moves to register r1 the character at position 0 ('t')
atpos r1, $str, 1
             
// Moves to register r2 the character at position 2 ('s')
atpos r2, $str, 2

// Inits register r3
mov r3, 3

// Moves to variable v2 the character at position indicated by r3 ('t')
atpos $v2, $str, r3
 </div>
