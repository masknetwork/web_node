   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>SPLIT</strong></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;SPLIT dest, haystack, delimiter</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">Will hold the splitted string as a list. It can be a register or a variable.</td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   ...
                   <td align="left" valign="top" class="fnt_14">The input string. It can be a register, a variable or a string.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td align="right" valign="top" class="fnt_14"><strong>delimiter</strong></td>
                   <td align="right" valign="top" class="fnt_14">&nbsp;</td>
                   <td align="left" valign="top" class="fnt_14">The boundary string. dest will be split by this substring.  It can be a register, a variable or a string.</td>
                 </tr>
                 </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Returns a list of strings, each of which is a substring of string formed by splitting it on boundaries formed by the string delimiter.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
...
// Split string "test me now" using space as delimiter
split r1, "test me now", " "
