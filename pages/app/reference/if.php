   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>IF</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;IF (expr), ins</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   <td align="right" valign="top" class="fnt_14"><strong>cond</strong></td>
                   <td>&nbsp;</td>
                   <td class="fnt_14">Expression to be evaluated. Expression is evaluated to its Boolean value. If expressionevaluates to <strong>TRUE</strong>, the system will execute the statement, and if it evaluates to <strong>FALSE</strong> - it'll ignore it. </td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td width="12%" align="right" valign="top" class="fnt_14"><strong>ins</strong></td>
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">Instruction to be executed in case <strong>expr</strong> evaluates to true.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>The <em>if </em>construct is one of the most important features of many languages, MSL (MaskNetwork Scripting Language) included. It allows for conditional execution of code.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
...
// IF register r1 is bigger that 3 exit
if (r1>5), log, "match"

// Inits variable $v
mov $v, "tests"

// Compare v to string "tests"
if ($v=="tests"), log, "match"

// Double comparison
if ($r1==2 && $v=="tests"), log, "match"

// Double comparison
if ($r1>1 && $v!="test"), log, "match"
 </div>
