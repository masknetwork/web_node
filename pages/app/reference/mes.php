   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>MES</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;MES dest, subj, mes</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">The recipient of the message. It can be a register, a variable or a string.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td width="12%" align="right" valign="top" class="fnt_14"><strong>subject</strong></td>
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">Message subject. It can be a register, a variable or a string.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td align="right" valign="top" class="fnt_14"><strong>message</strong></td>
                   <td>&nbsp;</td>
                   <td class="fnt_14">Message  It can be a register, a variable or a string.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Sends a message (mes) to an address (dest).</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             ...
             <div id="editor_code" align="left">// Subject
mov $subj, "Test subject"
             
// Message
mov $mes, "Test Message"

// Send message to address recipient. 
mes "ME4wEAYHKoZIzj0CAQYFK4EEACEDOgAEmzMuWmpif2JdeB1/UA7XQumglLj3o4/qF/CisxzJyXf7JoXXmGvBDJFbCSr8Si09zKtkfoA7jyU=", $subj, $mes
 </div>
