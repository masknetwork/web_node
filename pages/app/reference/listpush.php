   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>LISTPUSH</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;LISTPUSH dest, val</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">The list that will receive a new cell. It can be a variable or a register.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td width="12%" align="right" valign="top" class="fnt_14"><strong>val</strong></td>
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">This is the item to be pushed onto dest. It can be a variable, a register, a string or a number.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>The method is used to push val onto the top of dest, assuming that dest is a list.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             ...
             <div id="editor_code" align="left">// Adds string "one" to r1. 
listpush r1, "one"
             
// Adds string "two" to r1. 
listpush r1, "two"

// Adds string "three" to r1. 
listpush r1, "three"

// Copy to var $v the value at position 1
atpos $v, r1, 1
