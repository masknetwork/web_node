   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>LASTCH</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;LASTCH dest, haystack, no</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">The last <strong>no</strong> characters of this string will be stored as a new string in <strong>dest</strong> operand.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">The number of charcters</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Returns and stores in <strong>dest</strong>, the last <strong>no</strong> characters of string <strong>haystack</strong>. </td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
...
// Returns "st" and stores the string in variable $pos
indexof $pos, r1, 2

// Returns " test" and stores the string in variable $pos
indexof $pos, r1, 5
 </div>
