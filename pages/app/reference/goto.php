   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>GOTO</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;GOTO line</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   <td width="12%" align="right" valign="top" class="fnt_14"><strong>code</strong></td>
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">The line number where the execution will jump. It can be a register, a variable or an integer.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td> It performs a one-way transfer of control to another line of code. The line number is provided by <strong>line</strong> operand.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             ...
             <div id="editor_code" align="left">// Inits variable c
mov $c, 0
             
// Increase variable c
add $c, 1
             
// if $c is lower than 10, jump to line 3
if ($c<10), goto, 5
