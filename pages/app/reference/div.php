   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>DIV</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;DIV op1, op2</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   <td width="12%" align="right" valign="top" class="fnt_14"><strong>op1</strong></td>
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">Destination operand. This operand will hold the result containing the division between op1 and op2. It can be a register or a variable.</td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">The second operand. Op1 will be divided to this operand.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>This divides the value in the <strong>op1</strong> by <strong>op2</strong>. The result is stored into <strong>op1</strong>.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             ...
             <div id="editor_code" align="left">// Inits variable num
mov $num, 10
             
// Divides num variable by 2. The value of num will become 5.
div $num, 2
             
// Initi register r1
mov r1, 5

// Divides str by value contained in register r1. The new value of num will be 1.
div $num, r1
 </div>
