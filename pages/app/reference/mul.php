   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>MUL</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;MUL op1, op2</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>&nbsp;</td>
                   <td class="fnt_14">This operand will be multiplied by op2. It will also store the result. It can be a variable or a register.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td width="12%" align="right" valign="top" class="fnt_14"><strong>op2</strong></td>
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">This operand will be multiplied by op1.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Multiplies two operands (op1, op2) and place the result in the first operand (op1).</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             ...
             <div id="editor_code" align="left">// Copy 4 to r1
mov r1, 4
             
// Multiply r1 by 2 and stores the result(8) in r1
mul r1, 2

// Multiply r1 by 2.5 and stores the result(10) in r1
mul r1, 2.5
 </div>
