   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>TRIM</strong></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;TRIM str</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   <td align="right" valign="top" class="fnt_14"><strong>str</strong></td>
                   <td>&nbsp;</td>
                   <td class="fnt_14">The string that will be trimmed. It can be a register or a variable. This operand will also hold the result.</td>
                 </tr>
                 <tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Strip whitespace from the beginning and end of a string and stores the result in <strong>str</strong>.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
