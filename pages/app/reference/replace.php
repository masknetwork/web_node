   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>REPLACE</strong></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;REPLACE dest, haystack, niddle, replace</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   ...
                   <td align="left" valign="top" class="fnt_14">The string that will be searched. It can be a register, a variable or a string.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                 </tr>
                 <tr>
                   ...
                   <td align="right" valign="top" class="fnt_14">&nbsp;</td>
                   <td align="left" valign="top" class="fnt_14">The value being searched for, otherwise known as the <em>needle</em>.   It can be a register, a variable or a string.              </td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                 </tr>
                 <tr>
                   <td align="right" valign="top" class="fnt_14"><strong>replace</strong></td>
                   <td align="right" valign="top" class="fnt_14">&nbsp;</td>
                   <td align="left" valign="top" class="fnt_14">The replacement value that replaces found search values. It can be a register, a variable or a string.              </td>
                 </tr>
                 </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Replace all occurrences of the <strong>niddle</strong> string in the <strong>haystack</strong> with the replacement string (<strong>replace</strong>) and stores the result in <strong>dest</strong>.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
...
// Replace "te" by "me" and stores the result in $dest
replace $dest, r1, "te", "me"
 </div>
