   ...
   <tbody>
     <tr>
       ...
       <td width="71%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tbody>
           <tr>
             <td class="font_18"><strong>CONCAT</strong></td>
           </tr>
           <tr>
             <td><hr></td>
           </tr>
           <tr>
             <td bgcolor="#f5f5f5" class="font_16" height="40px"><strong>&nbsp;&nbsp;CONCAT dest, op</strong></td>
           </tr>
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 ...
                 <tr>
                   <td width="12%" align="right" valign="top" class="fnt_14"><strong>dest</strong></td>
                   <td width="3%">&nbsp;</td>
                   <td width="85%" class="fnt_14">Destination operand. This operand will hold the result containing the text of the joined strings. It can be a variable or a register.</td>
                 </tr>
                 <tr>
                   <td colspan="3" align="right" valign="top" class="fnt_14"><hr></td>
                   </tr>
                 <tr>
                   <td align="right" valign="top" class="fnt_14"><strong>op</strong></td>
                   <td>&nbsp;</td>
                   <td class="fnt_14">The string that will be added to dest. It can be a string, a register or a variable.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             <td height="60px" align="center" bgcolor="#f5f5f5" class="fnt_14"><table width="90%" border="0" cellpadding="0" cellspacing="0">
               <tbody>
                 <tr>
                   <td>Joins two  strings (dest and operand) and stores the resulting string in <strong>dest</strong> operand.</td>
                 </tr>
               </tbody>
             </table></td>
           </tr>
           ...
           <tr>
             ...
             <div id="editor_code" align="left">// Inits variable str
mov $str, "test"
             
// Concatenates string '11' to str variable. The new value of str will be 'test11'
concat $str, "11"
             
// Moves string "22" to register r1
mov r1, "22"

// Concatenates str and register r1. The new value of str will be 'test1122'
concat $str, r1
 </div>
