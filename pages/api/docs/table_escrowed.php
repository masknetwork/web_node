  ...
  ?>
   ...
   <td width="78%" align="center" valign="top"><table width="90%" border="0" cellpadding="0" cellspacing="0">
     <tbody>
       ...
       <tr>
         <td height="40" align="left" valign="top" class="font_18"><strong>Escrowed</strong></td>
       </tr>
       <tr>
         <td align="left" class="font_14"><hr></td>
       </tr>
       <tr>
         <td align="left" class="font_16">Escrowed table contains data about pending escrowed transactions.</td>
       </tr>
       <tr>
         <td align="center">&nbsp;</td>
       </tr>
       <tr>
         <td align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
           <tbody>
             <tr>
               <td width="22%" align="center"><strong class="font_14">trans_hash</strong>
                 <p class="font_10">String</p></td>
               <td width="78%" class="font_14">Transaction hash.</td>
             </tr>
             <tr>
               <td colspan="2" align="center"><hr></td>
               </tr>
             <tr>
               <td align="center"><strong class="font_14">sender_adr</strong>
                 <p class="font_10">string</p></td>
               <td class="font_14">Sender address.</td>
             </tr>
             <tr>
               <td colspan="2" align="center"><hr></td>
               </tr>
             <tr>
               <td align="center"><strong class="font_14">rec_adr</strong>
                 <p class="font_10">string</p></td>
               <td class="font_14">Receiver address.</td>
             </tr>
             <tr>
               <td colspan="2" align="center"><hr></td>
               </tr>
       ...
       <tr>
         <td align="left" class="font_14" height="40px">Get all pending escrowed transactions where the currency is MSK</td>
       </tr>
       <tr>
         <td align="center" class="font_16" bgcolor="#f0f0f0" height="70px"><strong>http://localhost/wallet/pages/api/public.php?table=escrowed&amp;col=cur&amp;type=exact&amp;val=MSK</strong></td>
       </tr>
       <tr>
         <td align="left">&nbsp;</td>
       </tr>
