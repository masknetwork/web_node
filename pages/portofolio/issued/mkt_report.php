...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
	 ...
	 // Help
	 $template->showHelp("Below is the updated market report. Keep in mind that a market owner win money when traders loose money and looses money when traders make money. The market's profit is trader loosses");
			   
	// Issued
    $issued->showMktReport($_REQUEST['mktID'], $_REQUEST['dd_interval']); 
?>
