<?
   ...
   include "CEscrowers.php";
   
   $db=new db();
   $template=new CTemplate($db);
   $ud=new CUserData($db);
   $sd=new CSysData($db);
   $escrowers=new CEscrowers($db, $template);
?>
...
?>
 ...
 <?
     // Location
     $template->showLocation("../../shop/goods/index.php", "Shop", "", "Escrowers");
	 
	  // Menu
	 if ($_REQUEST['ud']['ID']>0)
	 $template->showNav(2,
	                    "../../shop/escrowers/index.php", "Escrowers", "",
	                    "../../shop/escrowers/my_offers.php", "My Offerts", "");
	...
	switch ($_REQUEST['act'])
	{
		case "add" : $escrowers->addEscrower($_REQUEST['dd_esc_net_fee_adr'], 
		                                    $_REQUEST['dd_esc_adr'], 
											$_REQUEST['txt_esc_title'], 
											$_REQUEST['txt_esc_desc'], 
											$_REQUEST['txt_esc_web_page'], 
											$_REQUEST['txt_esc_fee'], 
											$_REQUEST['txt_esc_days']); 
					 break;
	}
	 
	// Buttons
	$escrowers->showAddBut();
	
	// My offers
	$escrowers->showEscrowers(true);
