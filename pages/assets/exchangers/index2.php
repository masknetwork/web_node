        ...
        <tbody>
          <tr>
            <td width="205" height="18" align="right" valign="top"><table width="201" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                <tr>
                  <td height="170" align="center" valign="middle" style="border-bottom-width:1px; border-bottom-style:inset; border-bottom-color:#ffffff;"><? $template->showBalancePanel(); ?></td>
                </tr>
              </tbody>
            </table>
            <?
            ...
            <table width="95%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                <tr>
                  <td width="59%">&nbsp;</td>
                  <td width="20%" align="right"><a href="new_offer.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>&nbsp;Add Offert </a></td>
                  <td width="21%" align="right"><a href="my_offerts.php" class="btn btn-warning"><span class="glyphicon glyphicon-th-list"></span>&nbsp;My Offerts </a></td>
                </tr>
              </tbody>
            </table></td>
