...
class CFeed
{
						...
						$days)
	{
		 ...
		 // Fee
		 if ($follow_fee<0 || $follow_fee>100)
		 {
			 $this->template->showErr("Invalid fee");
			 return false;
		 }
              ...
              <tr>
                <td height="30" align="left" valign="top" class="font_14"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" id="txt_branch_fee" name="txt_branch_fee" placeholder="0.0001" style="width:100px"/></td>
