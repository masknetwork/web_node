<?
   ...
   include "../CAssets.php";
   include "CAutoMkts.php";
   include "CAutoMkt.php";
        ...
        <tbody>
          <tr>
            ...
            <?
			   ...
			   if ($_REQUEST['act']=="new_pos")
			      $auto_mkt->newOrder($_REQUEST['dd_net_fee_adr'], 
				                      $_REQUEST['dd_adr'], 
									  $_REQUEST['mkt_symbol'], 
									  $_REQUEST['tip'], 
									  $_REQUEST['txt_qty']);
			   
			   $auto_mkt->showMarketPage($_REQUEST['symbol']);
			?>
