      ...
      <td height="800" align="center" valign="top" background="../../template/template/GIF/back_middle.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            ...
            <script>
			function menuClicked(panel)
			{
				$('#div_owners').css('display', 'none');
				$('#div_trans').css('display', 'none');
				$('#div_markets').css('display', 'none');
				
				switch (panel)
				{
					case 1: $('#div_owners').css('display', 'block'); break;
					case 2: $('#div_trans').css('display', 'block'); break;
					case 3: $('#div_markets').css('display', 'block'); break;
				}
			}
			</script>
            ...
            <?
			   $template->showHelp();	   
			   $asset->showAssetPage($_REQUEST['symbol']);
			?>
